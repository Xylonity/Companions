...
public class CompanionsServerEvents {
    ...
    @EventBusSubscriber(modid = CompanionsCommon.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
    public static class CompanionsServerModBus {
        ...
        public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
            event.register(CompanionsEntities.GOLDEN_ALLAY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, GoldenAllayEntity::checkGoldenAllaySpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
            event.register(CompanionsEntities.WILD_ANTLION.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WildAntlionEntity::checkMonsterSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
            event.register(CompanionsEntities.CORNELIUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, CorneliusEntity::checkCorneliusSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
        }
