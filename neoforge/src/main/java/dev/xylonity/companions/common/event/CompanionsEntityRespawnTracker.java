...
@EventBusSubscriber(modid = Companions.MOD_ID, bus = EventBusSubscriber.Bus.GAME)
    ...
    public static void onDeath(LivingDeathEvent event) {
        ...
        if (dead instanceof TamableAnimal tame) {
            ...
            if (ownerId != null) {
                ...
                if (owner != null) {
                    owner.sendSystemMessage(Component.translatable("respawn_totem.companions.charges_remaining", pos.toShortString(), totem.getCharges()));
                }
            }
        }
    }
