...
public class CompanionsEntities {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, Companions.MOD_ID);

    public static final Supplier<EntityType<CorneliusEntity>> CORNELIUS;
    public static final Supplier<EntityType<TeddyEntity>> TEDDY;
    public static final Supplier<EntityType<AntlionEntity>> ANTLION;
    public static final Supplier<EntityType<DinamoEntity>> DINAMO;
    public static final Supplier<EntityType<BrokenDinamoEntity>> BROKEN_DINAMO;
    public static final Supplier<EntityType<HostileImpEntity>> HOSTILE_IMP;
    public static final Supplier<EntityType<MinionEntity>> MINION;
    public static final Supplier<EntityType<GoldenAllayEntity>> GOLDEN_ALLAY;
    public static final Supplier<EntityType<SoulMageEntity>> SOUL_MAGE;
    public static final Supplier<EntityType<LivingCandleEntity>> LIVING_CANDLE;
    public static final Supplier<EntityType<CroissantDragonEntity>> CROISSANT_DRAGON;
    public static final Supplier<EntityType<PuppetGloveEntity>> PUPPET_GLOVE;
    public static final Supplier<EntityType<PuppetEntity>> PUPPET;
    public static final Supplier<EntityType<ShadeSwordEntity>> SHADE_SWORD;
    public static final Supplier<EntityType<ShadeMawEntity>> SHADE_MAW;
    public static final Supplier<EntityType<MankhEntity>> MANKH;
    public static final Supplier<EntityType<CloakEntity>> CLOAK;

    public static final Supplier<EntityType<FireworkToadEntity>> FIREWORK_TOAD;
    public static final Supplier<EntityType<BubbleFrogEntity>> BUBBLE_FROG;
    public static final Supplier<EntityType<EmberPoleEntity>> EMBER_POLE;
    public static final Supplier<EntityType<NetherBullfrogEntity>> NETHER_BULLFROG;
    public static final Supplier<EntityType<EnderFrogEntity>> ENDER_FROG;

    public static final Supplier<EntityType<IllagerGolemEntity>> ILLAGER_GOLEM;
    public static final Supplier<EntityType<HostilePuppetGloveEntity>> HOSTILE_PUPPET_GLOVE;
    public static final Supplier<EntityType<SacredPontiffEntity>> SACRED_PONTIFF;
    public static final Supplier<EntityType<WildAntlionEntity>> WILD_ANTLION;

    public static final Supplier<EntityType<SmallIceShardProjectile>> SMALL_ICE_SHARD_PROJECTILE;
    public static final Supplier<EntityType<BigIceShardProjectile>> BIG_ICE_SHARD_PROJECTILE;
    public static final Supplier<EntityType<TornadoProjectile>> TORNADO_PROJECTILE;
    public static final Supplier<EntityType<BloodTornadoProjectile>> BLOOD_TORNADO_PROJECTILE;
    public static final Supplier<EntityType<BloodSlashProjectile>> BLOOD_SLASH_PROJECTILE;
    public static final Supplier<EntityType<FireMarkProjectile>> FIRE_MARK_PROJECTILE;
    public static final Supplier<EntityType<FireMarkRingProjectile>> FIRE_MARK_RING_PROJECTILE;
    public static final Supplier<EntityType<StoneSpikeProjectile>> STONE_SPIKE_PROJECTILE;
    public static final Supplier<EntityType<HealRingProjectile>> HEAL_RING_PROJECTILE;
    public static final Supplier<EntityType<BraceProjectile>> BRACE_PROJECTILE;
    public static final Supplier<EntityType<MagicRayPieceProjectile>> MAGIC_RAY_PIECE_PROJECTILE;
    public static final Supplier<EntityType<FireRayPieceProjectile>> FIRE_RAY_PIECE_PROJECTILE;
    public static final Supplier<EntityType<MagicRayCircleProjectile>> MAGIC_RAY_PIECE_CIRCLE_PROJECTILE;
    public static final Supplier<EntityType<BlackHoleProjectile>> BLACK_HOLE_PROJECTILE;
    public static final Supplier<EntityType<SoulMageBookEntity>> SOUL_MAGE_BOOK;
    public static final Supplier<EntityType<FloorCakeCreamProjectile>> FLOOR_CAKE_CREAM;
    public static final Supplier<EntityType<StakeProjectile>> STAKE_PROJECTILE;
    public static final Supplier<EntityType<HolinessNaginataProjectile>> HOLINESS_NAGINATA;
    public static final Supplier<EntityType<HolinessStartProjectile>> HOLINESS_STAR;
    public static final Supplier<EntityType<PontiffFireRingProjectile>> PONTIFF_FIRE_RING;
    public static final Supplier<EntityType<ShadeSwordImpactProjectile>> SHADE_SWORD_IMPACT_PROJECTILE;
    public static final Supplier<EntityType<NeedleProjectile>> NEEDLE_PROJECTILE;
    public static final Supplier<EntityType<LaserTriggerProjectile>> LASER_PROJECTILE;
    public static final Supplier<EntityType<LaserRingProjectile>> LASER_RING;
    public static final Supplier<EntityType<FrogHealProjectile>> FROG_HEAL_PROJECTILE;
    ...
    public static final Supplier<EntityType<RedStarExplosionCenter>> RED_STAR_EXPLOSION_CENTER;
    public static final Supplier<EntityType<BlueStarExplosion>> BLUE_STAR_EXPLOSION;
    public static final Supplier<EntityType<BlueStarExplosionCenter>> BLUE_STAR_EXPLOSION_CENTER;
    public static final Supplier<EntityType<ShadeAltarUpgradeHaloProjectile>> SHADE_ALTAR_UPGRADE_HALO;
    public static final Supplier<EntityType<RespawnTotemRingProjectile>> RESPAWN_TOTEM_RING_PROJECTILE;

    public static final Supplier<EntityType<GenericTriggerProjectile>> GENERIC_TRIGGER_PROJECTILE;
