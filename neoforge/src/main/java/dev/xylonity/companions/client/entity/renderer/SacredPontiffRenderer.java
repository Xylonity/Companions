...
public class SacredPontiffRenderer extends GeoEntityRenderer<SacredPontiffEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, SacredPontiffEntity animatable, BakedGeoModel model, @Nullable RenderType renderType, MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        float radius;
    ...
    @Override
    public int getPackedOverlay(SacredPontiffEntity animatable, float u, float partialTick) {
