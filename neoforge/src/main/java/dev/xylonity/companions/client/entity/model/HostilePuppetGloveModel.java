...
public class HostilePuppetGloveModel extends GeoModel<HostilePuppetGloveEntity> {
    ...
    public ResourceLocation getModelResource(HostilePuppetGloveEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "geo/hostile_puppet_glove.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HostilePuppetGloveEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "textures/entity/puppet_glove.png");
    }

    @Override
    public ResourceLocation getAnimationResource(HostilePuppetGloveEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "animations/hostile_puppet_glove.animation.json");
    }
