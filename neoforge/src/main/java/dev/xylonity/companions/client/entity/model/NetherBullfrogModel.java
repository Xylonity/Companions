...
public class NetherBullfrogModel extends GeoModel<NetherBullfrogEntity> {
    ...
    public ResourceLocation getModelResource(NetherBullfrogEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "geo/nether_bullfrog.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(NetherBullfrogEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "textures/entity/nether_bullfrog.png");
    }

    @Override
    public ResourceLocation getAnimationResource(NetherBullfrogEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "animations/nether_bullfrog.animation.json");
    }
