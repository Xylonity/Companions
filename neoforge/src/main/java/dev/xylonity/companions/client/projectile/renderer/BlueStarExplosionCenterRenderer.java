...
public class BlueStarExplosionCenterRenderer extends GeoEntityRenderer<BlueStarExplosionCenter> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, BlueStarExplosionCenter animatable, BakedGeoModel model, @Nullable RenderType renderType, MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
