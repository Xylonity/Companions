...
public final class CompanionsRecipes {
    ...
    public static void init() {
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, new ResourceLocation(Companions.MOD_ID, "shade_maw_altar_interaction"), CHALICE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, new ResourceLocation(Companions.MOD_ID, "shade_maw_altar_interaction"), CHALICE_TYPE);

        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, new ResourceLocation(Companions.MOD_ID, "soul_furnace"), SOUL_FURNACE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, new ResourceLocation(Companions.MOD_ID, "soul_furnace"), SOUL_FURNACE_TYPE);
    }
