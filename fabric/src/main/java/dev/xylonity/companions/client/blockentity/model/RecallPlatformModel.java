...
public class RecallPlatformModel extends GeoModel<RecallPlatformBlockEntity> {
    ...
    public ResourceLocation getModelResource(RecallPlatformBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "geo/recall_platform_block.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RecallPlatformBlockEntity animatable) {
        if (animatable.isActive()) {
            return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "textures/block/recall_platform_on_block.png");
        }

        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "textures/block/recall_platform_block.png");
    }
