    ...
    public ResourceLocation getTextureResource(ShadeSwordEntity animatable) {
        if (animatable.hasReskin()) {
            if (animatable.isBlood()) {
                return new ResourceLocation(CompanionsCommon.MOD_ID, "textures/entity/shade_sword_blood_reskin.png");
            }

            return new ResourceLocation(CompanionsCommon.MOD_ID, "textures/entity/shade_sword_reskin.png");
        }
