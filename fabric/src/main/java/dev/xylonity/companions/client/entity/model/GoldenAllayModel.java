...
public class GoldenAllayModel extends GeoModel<GoldenAllayEntity> {
    ...
    public ResourceLocation getModelResource(GoldenAllayEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "geo/golden_allay.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GoldenAllayEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "textures/entity/golden_allay.png");
    }

    @Override
    public ResourceLocation getAnimationResource(GoldenAllayEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "animations/golden_allay.animation.json");
    }
