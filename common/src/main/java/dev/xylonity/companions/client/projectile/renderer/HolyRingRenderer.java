...
public class HolyRingRenderer extends GeoEntityRenderer<HolyRingProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, HolyRingProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        ...
        super.actuallyRender(poseStack, animatable, model, renderType, bufferSource, buffer, isReRender, partialTick, LightTexture.pack(15, 15), packedOverlay, KnightLibColor.withAlpha(colour, (int) (0.9f * fade * 255)));
    }
