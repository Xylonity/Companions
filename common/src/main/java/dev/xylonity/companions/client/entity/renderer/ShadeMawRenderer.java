...
public class ShadeMawRenderer extends GeoEntityRenderer<ShadeMawEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ShadeMawEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
