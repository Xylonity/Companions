...
public class ShadeSwordImpactRenderer extends GeoEntityRenderer<ShadeSwordImpactProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ShadeSwordImpactProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
