...
public class CompanionsClientEvents {
    ...
    public static void registerAdditionalModels(final AdditionalModelsRegistrationEvent event) {
        event.register(Companions.of("item/crystallized_blood_axe_icon"));
        event.register(Companions.of("item/crystallized_blood_scythe_icon"));
        event.register(Companions.of("item/crystallized_blood_sword_icon"));
        event.register(Companions.of("item/mage_staff_icon"));
    }
