...
public class NeedleRenderer extends GeoEntityRenderer<NeedleProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, NeedleProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
