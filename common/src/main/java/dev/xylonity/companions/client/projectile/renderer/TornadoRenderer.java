...
public class TornadoRenderer extends GeoEntityRenderer<TornadoProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, TornadoProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
