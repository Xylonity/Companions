...
public class FireGeiserProjectileRenderer extends GeoEntityRenderer<FireGeiserProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, FireGeiserProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        poseStack.scale(1.25f, 1.25f, 1.25f);
        super.actuallyRender(poseStack, animatable, model, renderType, bufferSource, buffer, isReRender, partialTick, LightTexture.FULL_SKY, packedOverlay, colour);
    }
