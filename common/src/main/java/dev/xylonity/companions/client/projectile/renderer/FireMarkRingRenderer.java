...
public class FireMarkRingRenderer extends GeoEntityRenderer<FireMarkRingProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, FireMarkRingProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
