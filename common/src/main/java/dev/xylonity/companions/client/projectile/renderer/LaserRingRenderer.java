...
public class LaserRingRenderer extends GeoEntityRenderer<LaserRingProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, LaserRingProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
