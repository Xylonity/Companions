...
public class IceShardSmallRenderer extends GeoEntityRenderer<SmallIceShardProjectile> {
    ...
    @Override
    protected void applyRotations(SmallIceShardProjectile entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTicks, float nativeScale) {
