...
public class SoulFurnaceRenderer extends AbstractGeoBlockRenderer<SoulFurnaceBlockEntity> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull SoulFurnaceBlockEntity animatable) {
        if (animatable.getLevel() != null) {
            ...
            if (state.hasProperty(SoulFurnaceBlock.LIT) && state.getValue(SoulFurnaceBlock.LIT)) {
                return Companions.of("textures/block/soul_furnace_on_block.png");
            }
        }

        return Companions.of("textures/block/soul_furnace_block.png");
    }
