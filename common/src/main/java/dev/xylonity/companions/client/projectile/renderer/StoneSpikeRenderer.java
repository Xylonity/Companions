...
public class StoneSpikeRenderer extends GeoEntityRenderer<StoneSpikeProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, StoneSpikeProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
