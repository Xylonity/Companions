...
public class ShadeBatPartRenderer extends GeoEntityRenderer<ShadeBatPartEntity> {
    ...
    @Override
    protected void applyRotations(ShadeBatPartEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ShadeBatPartEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        ...
        super.actuallyRender(poseStack, animatable, model, renderType, bufferSource, buffer, isReRender, partialTick, packedLight, packedOverlay, dev.xylonity.knightlib.api.util.KnightLibColor.multiplyAlpha(colour, fade));
    }
