...
public class ShadeBatRenderer extends GeoEntityRenderer<ShadeBatEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ShadeBatEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
