...
public class MagicRayPieceRenderer extends GeoEntityRenderer<MagicRayPieceProjectile> {
    ...
    @Override
    protected void applyRotations(MagicRayPieceProjectile entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
