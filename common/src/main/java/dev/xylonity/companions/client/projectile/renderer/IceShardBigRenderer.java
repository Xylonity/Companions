...
public class IceShardBigRenderer extends GeoEntityRenderer<BigIceShardProjectile> {
    ...
    @Override
    protected void applyRotations(BigIceShardProjectile entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTicks, float nativeScale) {
