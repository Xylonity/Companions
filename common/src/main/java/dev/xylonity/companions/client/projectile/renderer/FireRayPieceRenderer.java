...
public class FireRayPieceRenderer extends GeoEntityRenderer<FireRayPieceProjectile> {
    ...
    @Override
    protected void applyRotations(FireRayPieceProjectile entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
