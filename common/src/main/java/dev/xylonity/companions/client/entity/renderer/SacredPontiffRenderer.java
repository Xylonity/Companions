...
public class SacredPontiffRenderer extends GeoEntityRenderer<SacredPontiffEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, SacredPontiffEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        float radius;
