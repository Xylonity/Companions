...
public class ScrollRenderer extends GeoEntityRenderer<ScrollProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ScrollProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
