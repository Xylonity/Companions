...
public class ShadeMawModel extends GeoModel<ShadeMawEntity> {
    ...
    public ResourceLocation getModelResource(ShadeMawEntity animatable) {
        return new ResourceLocation(Companions.MOD_ID, "geo/shade_maw.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ShadeMawEntity animatable) {
        if (animatable.isBlood()) {
            return new ResourceLocation(Companions.MOD_ID, "textures/entity/shade_maw_blood.png");
        }

        return new ResourceLocation(Companions.MOD_ID, "textures/entity/shade_maw.png");
    }

    @Override
    public ResourceLocation getAnimationResource(ShadeMawEntity animatable) {
        return new ResourceLocation(Companions.MOD_ID, "animations/shade_maw.animation.json");
    }
