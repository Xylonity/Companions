...
public class MinionRenderer extends GeoEntityRenderer<MinionEntity> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, MinionEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
