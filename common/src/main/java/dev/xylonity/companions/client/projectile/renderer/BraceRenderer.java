...
public class BraceRenderer extends GeoEntityRenderer<BraceProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, BraceProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
