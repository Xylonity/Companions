...
public class HolinessNaginataRenderer extends GeoEntityRenderer<HolinessNaginataProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, HolinessNaginataProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
