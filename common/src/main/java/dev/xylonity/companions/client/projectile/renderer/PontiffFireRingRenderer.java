...
public class PontiffFireRingRenderer extends GeoEntityRenderer<PontiffFireRingProjectile> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, PontiffFireRingProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
