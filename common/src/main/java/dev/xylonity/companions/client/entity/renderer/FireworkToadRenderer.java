...
public class FireworkToadRenderer extends GeoEntityRenderer<FireworkToadEntity> {
    ...
    @Override
    protected void applyRotations(FireworkToadEntity tamable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTicks, float nativeScale) {
        ...
        if (center != null) {
            ...
            super.applyRotations(tamable, poseStack, ageInTicks, rotationYaw, partialTicks, nativeScale);
        }
