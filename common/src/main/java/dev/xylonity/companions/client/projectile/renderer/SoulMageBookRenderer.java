...
public class SoulMageBookRenderer extends GeoEntityRenderer<SoulMageBookEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, SoulMageBookEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
    ...
    static class SoulMageBookGlowLayer extends GeoRenderLayer<SoulMageBookEntity> {
        ...
        public void render(PoseStack poseStack, SoulMageBookEntity entity, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
            ...
            getRenderer().reRender(bakedModel, poseStack, bufferSource, entity, glowRenderType, glowBuffer, partialTick, packedLight, OverlayTexture.NO_OVERLAY, net.minecraft.util.FastColor.ARGB32.colorFromFloat(1.0f, r, g, b));
        }
