...
public class TeslaCoilRenderer extends GeoBlockRenderer<TeslaCoilBlockEntity> implements ITeslaUtil {
    ...
    @Override
    public void render(TeslaCoilBlockEntity teslaCoilBlockEntity, float v, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int i1) {
        this.animatable = teslaCoilBlockEntity;
