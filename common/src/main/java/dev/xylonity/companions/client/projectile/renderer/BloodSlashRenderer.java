...
public class BloodSlashRenderer extends GeoEntityRenderer<BloodSlashProjectile> {
    ...
    @Override
    protected void applyRotations(BloodSlashProjectile entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTicks, float nativeScale) {
        ...
        super.applyRotations(entity, poseStack, ageInTicks, rotationYaw, partialTicks, nativeScale);
    }

    @Override
    public void actuallyRender(PoseStack poseStack, BloodSlashProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
