...
public final class CroissantDragonArmorRecipeCategory implements IRecipeCategory<CroissantDragonArmorRecipe> {
    ...
    public void draw(@NotNull CroissantDragonArmorRecipe recipe, @NotNull IRecipeSlotsView slots, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        try {
            ...
            dragonRenderer1.render(dragon1, 0f, Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(true), pose, buffer, LightTexture.pack(15, 15));
        }
        ...
        try {
            ...
            dragonRenderer2.render(dragon2, 0f, Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(true), pose, buffer, LightTexture.pack(15, 15));
        }
