...
public final class CompanionsPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration reg) {
        ...
        if (lvl != null) {
            ...
            for (net.minecraft.world.item.crafting.RecipeHolder<SoulFurnaceRecipe> holder : lvl.getRecipeManager().getAllRecipesFor(CompanionsRecipeTypes.SOUL_FURNACE_TYPE.get())) {
