...
public class CompanionsEffects {
    ...
    public static final Supplier<MobEffect> FIRE_MARK = EFFECTS.register("fire_mark", FireMarkEffect::new);
    public static final Supplier<MobEffect> ELECTROSHOCK = EFFECTS.register("electroshock", ElectroshockEffect::new);
    public static final Supplier<MobEffect> VOODOO = EFFECTS.register("voodoo", VoodooEffect::new);
    public static final Supplier<MobEffect> PHANTOM = EFFECTS.register("phantom", PhantomEffect::new);
