...
public class CompanionsItems {
    ...
    public static final ResourceEntry<Item> MAGE_HAT = ITEMS.register("mage_hat", () -> new GeckoMageArmorItem(ArmorMaterials.MAGE, ArmorItem.Type.HELMET, new Item.Properties(), "mage_hat"));
    public static final ResourceEntry<Item> MAGE_COAT = ITEMS.register("mage_coat", () -> new GeckoMageArmorItem(ArmorMaterials.MAGE, ArmorItem.Type.CHESTPLATE, new Item.Properties(), "mage_coat"));
    public static final ResourceEntry<Item> MAGE_LEGGINGS = ITEMS.register("mage_leggings", () -> new GeckoMageArmorItem(ArmorMaterials.MAGE, ArmorItem.Type.LEGGINGS, new Item.Properties(), "mage_leggings"));
    ...
    public static final ResourceEntry<Item> HOLY_ROBE_MASK = ITEMS.register("holy_robe_mask", () -> new GeckoHolyRobeArmorItem(ArmorMaterials.HOLY_ROBE.get(), ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1), "holy_robe_mask"));
    public static final ResourceEntry<Item> HOLY_ROBE_COAT = ITEMS.register("holy_robe_coat", () -> new GeckoHolyRobeArmorItem(ArmorMaterials.HOLY_ROBE.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1), "holy_robe_coat"));
    public static final ResourceEntry<Item> HOLY_ROBE_LEGGINGS = ITEMS.register("holy_robe_leggings", () -> new GeckoHolyRobeArmorItem(ArmorMaterials.HOLY_ROBE.get(), ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1), "holy_robe_leggings"));

    public static final ResourceEntry<Item> CRYSTALLIZED_BLOOD_HELMET = ITEMS.register("crystallized_blood_helmet", () -> new GeckoBloodArmorItem(ArmorMaterials.CRYSTALLIZED_BLOOD.get(), ArmorItem.Type.HELMET, new Item.Properties().fireResistant(), "crystallized_blood_helmet"));
    public static final ResourceEntry<Item> CRYSTALLIZED_BLOOD_CHESTPLATE = ITEMS.register("crystallized_blood_chestplate", () -> new BloodArmorItem(ArmorMaterials.CRYSTALLIZED_BLOOD.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant()));
    public static final ResourceEntry<Item> CRYSTALLIZED_BLOOD_LEGGINGS = ITEMS.register("crystallized_blood_leggings", () -> new BloodArmorItem(ArmorMaterials.CRYSTALLIZED_BLOOD.get(), ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant()));
    public static final ResourceEntry<Item> CRYSTALLIZED_BLOOD_BOOTS = ITEMS.register("crystallized_blood_boots", () -> new BloodArmorItem(ArmorMaterials.CRYSTALLIZED_BLOOD.get(), ArmorItem.Type.BOOTS, new Item.Properties().fireResistant()));
