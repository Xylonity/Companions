...
public class CompanionsItems {
    ...
    public static final Supplier<Item> MUTANT_FLESH = registerItem("mutant_flesh", () -> new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(10).saturationMod(0.6F).meat().build())));
    public static final Supplier<Item> DEMON_FLESH = registerItem("demon_flesh", () -> new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(10).saturationMod(0.6F).meat().build())));
