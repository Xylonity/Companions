...
public interface IProxy {
    ...
    default void spawnGoldenAllayRibbonTrail(Entity e, Level level, double x, double y, double z, float r, float g, float b, float radius, float height) { ;; }
    default void spawnBaseProjectileTrail(Entity entity, float radius, float height, float r, float g, float b) { ;; }
    default void spawnSidedRibbonTrail(Entity e, Level level, double x, double y, double z, float r, float g, float b, float radius, float height, int side) { ;; }
