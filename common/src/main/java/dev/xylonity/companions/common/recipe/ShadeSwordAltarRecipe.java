...
public final class ShadeSwordAltarRecipe implements Recipe<SimpleContainer> {
    ...
    private static final ResourceLocation ID = new ResourceLocation(CompanionsFabric.MOD_ID, "shade_sword_altar_interaction");
    ...
    public static final class Serializer implements RecipeSerializer<ShadeSwordAltarRecipe> {
        @Override
        public @NotNull ShadeSwordAltarRecipe fromJson(@NotNull ResourceLocation id, @NotNull JsonObject json) {
            return new ShadeSwordAltarRecipe();
        }

        @Override
        public ShadeSwordAltarRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            return new ShadeSwordAltarRecipe();
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, @NotNull ShadeSwordAltarRecipe rec) { ;; }
    }
