...
public class SoulMageBookEntity extends BaseProjectile {
    ...
    protected void defineSynchedData(@NotNull SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(TARGET_RED, 255);
        pBuilder.define(TARGET_GREEN, 255);
        pBuilder.define(TARGET_BLUE, 255);
        pBuilder.define(CURRENT_RED, 255.0f);
        pBuilder.define(CURRENT_GREEN, 255.0f);
        pBuilder.define(CURRENT_BLUE, 255.0f);
    }
