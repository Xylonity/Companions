...
public class PuppetRightCannonAttackGoal extends AbstractPuppetRightAttackGoal {
    ...
    protected void performAttack(LivingEntity target) {
        ...
        Vec3 startPos = puppet.getEyePosition(1.0F).add(offset);
    ...
    protected boolean hasRequiredArm() {
        return puppet.inventory.getItem(0).is(CompanionsItems.CANNON_ARM.get());
    }
