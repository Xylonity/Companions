...
public class CorneliusNetherBullfrogGoal extends AbstractCorneliusAttackGoal {

    public CorneliusNetherBullfrogGoal(CorneliusEntity cornelius, int minCd, int maxCd) {
        super(cornelius, minCd, maxCd);
    }

    @Override
    protected void performAttack(LivingEntity target) {
        BlockPos spawnPos = findPosAroundTarget();
