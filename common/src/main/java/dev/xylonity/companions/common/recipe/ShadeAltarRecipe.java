...
public final class ShadeAltarRecipe implements Recipe<SimpleContainer> {

    private static final ResourceLocation ID = new ResourceLocation(CompanionsFabric.MOD_ID, "shade_altar_interaction");
    ...
    public static final class Serializer implements RecipeSerializer<ShadeAltarRecipe> {
        @Override
        public @NotNull ShadeAltarRecipe fromJson(@NotNull ResourceLocation id, @NotNull JsonObject json) {
            return new ShadeAltarRecipe();
        }

        @Override
        public ShadeAltarRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            return new ShadeAltarRecipe();
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, @NotNull ShadeAltarRecipe rec) { ;; }
    }
