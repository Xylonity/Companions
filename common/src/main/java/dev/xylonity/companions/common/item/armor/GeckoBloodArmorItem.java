...
public class GeckoBloodArmorItem extends GeckoArmorItem {

    public GeckoBloodArmorItem(net.minecraft.core.Holder<ArmorMaterial> armorMaterial, Type type, Properties properties, String resourceKey) {
