...
public class SoulFurnaceContainerMenu extends AbstractContainerMenu {
    ...
    private boolean isValidInput(ItemStack stack) {
        ...
        for (net.minecraft.world.item.crafting.RecipeHolder<SoulFurnaceRecipe> holder : player.level().getRecipeManager().getAllRecipesFor(CompanionsRecipeTypes.SOUL_FURNACE_TYPE.get())) {
