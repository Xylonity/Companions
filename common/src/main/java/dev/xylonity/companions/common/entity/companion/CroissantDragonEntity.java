...
public class CroissantDragonEntity extends CompanionEntity {
    ...
    protected void defineSynchedData(@NotNull SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(ARMOR_NAME, "default");
        pBuilder.define(EATEN_AMOUNT, 0);
        pBuilder.define(HAS_BEEN_EATEN, false);
        pBuilder.define(MILK_AMOUNT, 0);
        pBuilder.define(VIEW_VEC_X, 0f);
        pBuilder.define(VIEW_VEC_Y, 0f);
        pBuilder.define(VIEW_VEC_Z, 0f);
    }
