...
public final class CroissantEggRecipe implements Recipe<SimpleContainer> {

    private static final ResourceLocation ID = new ResourceLocation(CompanionsFabric.MOD_ID, "croissant_egg_interaction");
    ...
    public static final class Serializer implements RecipeSerializer<CroissantEggRecipe> {
        @Override
        public @NotNull CroissantEggRecipe fromJson(@NotNull ResourceLocation id, @NotNull JsonObject json) {
            return new CroissantEggRecipe();
        }

        @Override
        public CroissantEggRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            return new CroissantEggRecipe();
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, @NotNull CroissantEggRecipe rec) { ;; }
    }
