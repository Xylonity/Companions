...
public class ShadeBatEntity extends ShadeEntity {
    ...
    protected @NotNull EntityDimensions getDefaultDimensions(@NotNull Pose pPose) {
        return isBlood() ? EntityDimensions.scalable(0.75F, 1.5F) : super.getDefaultDimensions(pPose);
    }
    ...
    protected void defineSynchedData(@NotNull SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(SHADE_BAT_TARGET_ID, -1);
        pBuilder.define(ALIVE_PARTS_MASK, -1);
    }
