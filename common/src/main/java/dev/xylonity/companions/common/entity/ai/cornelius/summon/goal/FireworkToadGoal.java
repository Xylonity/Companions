...
public class FireworkToadGoal extends AbstractCorneliusSummonAttackGoal {
    ...
    private static void rocket(ServerLevel world, Vec3 where, RandomSource r) {
        ...
        if (rand < 0.3) {
            // circle
            shape = r.nextBoolean() ? net.minecraft.world.item.component.FireworkExplosion.Shape.SMALL_BALL : net.minecraft.world.item.component.FireworkExplosion.Shape.LARGE_BALL;
        } else if (rand < 0.6) {
            // star
            shape = net.minecraft.world.item.component.FireworkExplosion.Shape.STAR;
        } else {
            // burst
            shape = net.minecraft.world.item.component.FireworkExplosion.Shape.BURST;
        }
        ...
        net.minecraft.world.item.component.FireworkExplosion exp = new net.minecraft.world.item.component.FireworkExplosion(
                shape, it.unimi.dsi.fastutil.ints.IntList.of(color), it.unimi.dsi.fastutil.ints.IntList.of(color), false, true);

        ItemStack stack = new ItemStack(Items.FIREWORK_ROCKET);
        stack.set(net.minecraft.core.component.DataComponents.FIREWORKS, new net.minecraft.world.item.component.Fireworks(1, java.util.List.of(exp)));
