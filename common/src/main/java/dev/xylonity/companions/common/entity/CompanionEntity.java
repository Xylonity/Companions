...
public abstract class CompanionEntity extends TamableAnimal implements GeoEntity {
    ...
    protected void defineSynchedData(@NotNull SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(MAIN_ACTION, 1);
        pBuilder.define(NO_MOVEMENT, false);
        pBuilder.define(SIT_VARIATION, 0);
    }
    ...
    public void readAdditionalSaveData(@NotNull CompoundTag pCompound) {
        ...
        if (pCompound.contains("RespawnTotemPos")) {
            respawnTotemPos = pCompound.getLong("RespawnTotemPos");
            respawnTotemDim = ResourceLocations.parse(pCompound.getString("RespawnTotemDim"));
        }
    ...
    public void addAdditionalSaveData(@NotNull CompoundTag pCompound) {
        ...
        if (respawnTotemPos != Long.MIN_VALUE) {
            pCompound.putLong("RespawnTotemPos", respawnTotemPos);
            pCompound.putString("RespawnTotemDim", respawnTotemDim.toString());
        }
