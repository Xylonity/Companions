...
public final class ArmorMaterials {
    ...
    public static final KnightLibArmorMaterial MAGE = fromConfig("mage", CompanionsConfig.MAGE_SET_STATS);
    public static final KnightLibArmorMaterial HOLY_ROBE = fromConfig("holy_robe", CompanionsConfig.HOLY_ROBE_SET_STATS);
    public static final KnightLibArmorMaterial CRYSTALLIZED_BLOOD = fromConfig("crystallized_blood", CompanionsConfig.CRYSTALLIZED_BLOOD_SET_STATS);
