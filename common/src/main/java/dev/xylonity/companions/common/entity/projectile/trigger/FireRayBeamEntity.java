...
public class FireRayBeamEntity extends Entity implements GeoAnimatable {
    ...
    protected void defineSynchedData(@NotNull SynchedEntityData.Builder pBuilder) {
        pBuilder.define(ORIGIN_X, 0.0F);
        pBuilder.define(ORIGIN_Y, 0.0F);
        pBuilder.define(ORIGIN_Z, 0.0F);
        pBuilder.define(START_YAW, 0.0F);
        pBuilder.define(ROT_TICKS,  0);
        pBuilder.define(MAX_PIECES, 0);
        pBuilder.define(SEPARATION, 0.0F);
        pBuilder.define(START_PITCH, 0f);
    }
