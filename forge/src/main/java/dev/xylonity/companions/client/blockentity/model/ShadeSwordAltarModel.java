...
public class ShadeSwordAltarModel extends GeoModel<ShadeSwordAltarBlockEntity> {
    ...
    public ResourceLocation getModelResource(ShadeSwordAltarBlockEntity animatable) {
        return new ResourceLocation(CompanionsForge.MOD_ID, "geo/shade_sword_altar.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ShadeSwordAltarBlockEntity animatable) {
        if (animatable.isBloodUpgradeActive()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_sword_altar_blood.png");
        } else if (animatable.getCharges() == 0) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_sword_altar_off.png");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_sword_altar.png");
    }

    @Override
    public ResourceLocation getAnimationResource(ShadeSwordAltarBlockEntity animatable) {
        return new ResourceLocation(CompanionsForge.MOD_ID, "animations/shade_sword_altar.animation.json");
    }
