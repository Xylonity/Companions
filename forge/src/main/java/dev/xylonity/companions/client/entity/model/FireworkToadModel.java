...
public class FireworkToadModel extends GeoModel<FireworkToadEntity> {
    ...
    public ResourceLocation getModelResource(FireworkToadEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "geo/firework_toad.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(FireworkToadEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "textures/entity/firework_toad.png");
    }

    @Override
    public ResourceLocation getAnimationResource(FireworkToadEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "animations/firework_toad.animation.json");
    }
