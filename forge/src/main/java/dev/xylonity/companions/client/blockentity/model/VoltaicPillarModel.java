...
public class VoltaicPillarModel extends GeoModel<VoltaicPillarBlockEntity> {
    ...
    public ResourceLocation getModelResource(VoltaicPillarBlockEntity animatable) {
        if (animatable.isTop() && !animatable.hasBlockOnTop()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "geo/voltaic_pillar_top_block.geo.json");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "geo/voltaic_pillar_block.geo.json");
    }
    ...
    public ResourceLocation getTextureResource(VoltaicPillarBlockEntity animatable) {
        if (animatable.isTop() && !animatable.hasBlockOnTop()) {
            if (animatable.isActive()) {
                return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_pillar_top_block_on.png");
            }

            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_pillar_top_block.png");
        }

        if (animatable.isActive()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_pillar_block_on.png");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_pillar_block.png");
    }
