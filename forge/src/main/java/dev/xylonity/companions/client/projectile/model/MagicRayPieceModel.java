...
public class MagicRayPieceModel extends GeoModel<MagicRayPieceProjectile> {
    ...
    public ResourceLocation getModelResource(MagicRayPieceProjectile animatable) {
        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "geo/magic_ray_piece.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MagicRayPieceProjectile animatable) {
        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "textures/entity/magic_ray_piece.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MagicRayPieceProjectile animatable) {
        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "animations/magic_ray_piece.animation.json");
    }
