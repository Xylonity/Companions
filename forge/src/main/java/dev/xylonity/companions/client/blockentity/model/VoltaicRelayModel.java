...
public class VoltaicRelayModel extends GeoModel<VoltaicRelayBlockEntity> {
    ...
    public ResourceLocation getModelResource(VoltaicRelayBlockEntity animatable) {
        ...
        return new ResourceLocation(CompanionsForge.MOD_ID, "geo/voltaic_relay_block_" + dirName + ".geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(VoltaicRelayBlockEntity animatable) {
        if (animatable.isActive()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_relay_block_on.png");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/voltaic_relay_block.png");
    }
