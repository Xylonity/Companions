...
public class VoltaicRelayModel extends GeoModel<VoltaicRelayBlockEntity> {
    ...
    public ResourceLocation getModelResource(VoltaicRelayBlockEntity animatable) {
        ...
        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "geo/voltaic_relay_block_" + dirName + ".geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(VoltaicRelayBlockEntity animatable) {
        if (animatable.isActive()) {
            return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "textures/block/voltaic_relay_block_on.png");
        }

        return ResourceLocation.fromNamespaceAndPath(Companions.MOD_ID, "textures/block/voltaic_relay_block.png");
    }
