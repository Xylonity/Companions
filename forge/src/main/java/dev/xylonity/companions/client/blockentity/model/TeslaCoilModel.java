...
public class TeslaCoilModel extends GeoModel<TeslaCoilBlockEntity> {
    ...
    public ResourceLocation getModelResource(TeslaCoilBlockEntity animatable) {
        ...
        return new ResourceLocation(CompanionsForge.MOD_ID, "geo/tesla_coil_block_" + dirName + ".geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TeslaCoilBlockEntity animatable) {
        if (animatable.isActive()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/tesla_coil_block_on.png");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/tesla_coil_block.png");
    }
