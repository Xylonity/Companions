...
public class EmberPoleModel extends GeoModel<EmberPoleEntity> {
    ...
    public ResourceLocation getModelResource(EmberPoleEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "geo/ember_pole.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(EmberPoleEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "textures/entity/ember_pole.png");
    }

    @Override
    public ResourceLocation getAnimationResource(EmberPoleEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(CompanionsCommon.MOD_ID, "animations/ember_pole.animation.json");
    }
