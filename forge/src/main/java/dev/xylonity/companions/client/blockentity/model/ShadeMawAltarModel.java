...
public class ShadeMawAltarModel extends GeoModel<ShadeMawAltarBlockEntity> {
    ...
    public ResourceLocation getModelResource(ShadeMawAltarBlockEntity animatable) {
        return new ResourceLocation(CompanionsForge.MOD_ID, "geo/shade_maw_altar.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ShadeMawAltarBlockEntity animatable) {
        if (animatable.isBloodUpgradeActive()) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_maw_altar_blood.png");
        } else if (animatable.getCharges() == 0) {
            return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_maw_altar_off.png");
        }

        return new ResourceLocation(CompanionsForge.MOD_ID, "textures/block/shade_maw_altar.png");
    }

    @Override
    public ResourceLocation getAnimationResource(ShadeMawAltarBlockEntity animatable) {
        return new ResourceLocation(CompanionsForge.MOD_ID, "animations/shade_maw_altar.animation.json");
    }
