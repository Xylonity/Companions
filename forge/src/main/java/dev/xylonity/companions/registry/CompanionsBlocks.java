...
public class CompanionsBlocks {
    ...
    public static final RegistryObject<Block> SOUL_FURNACE;
    ...
    static {
        ...
        SOUL_FURNACE = register("soul_furnace_block",
    ...
    private static <X extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<X> block) {
        return Companions.ITEMS.register(name, () -> new GenericBlockItem(block.get(), new Item.Properties(), name));
    }
