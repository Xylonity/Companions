...
public class NetherBullfrogEntity extends CompanionSummonEntity {

    private static final EntityDataAccessor<Boolean> CAN_EXPLODE = SynchedEntityData.defineId(NetherBullfrogEntity.class, EntityDataSerializers.BOOLEAN);
