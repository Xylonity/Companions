...
public class CorneliusEmberPoleGoal extends AbstractCorneliusAttackGoal {

    public CorneliusEmberPoleGoal(CorneliusEntity cornelius, int minCd, int maxCd) {
