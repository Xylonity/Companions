package dev.xylonity.companions.common.entity.ai.soul_mage.control;
...
public class GoldenAllayMoveControl extends MoveControl {
    private final GoldenAllayEntity teddy;

    public GoldenAllayMoveControl(GoldenAllayEntity teddy) {
        super(teddy);
        this.teddy = teddy;
    }
