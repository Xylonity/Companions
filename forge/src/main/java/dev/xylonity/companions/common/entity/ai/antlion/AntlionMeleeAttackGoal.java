...
public class AntlionMeleeAttackGoal extends Goal {
    protected final AntlionEntity mob;
    ...
    public AntlionMeleeAttackGoal(AntlionEntity pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
