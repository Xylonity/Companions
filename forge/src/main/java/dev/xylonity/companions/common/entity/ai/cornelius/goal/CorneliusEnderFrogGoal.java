...
public class CorneliusEnderFrogGoal extends AbstractCorneliusAttackGoal {

    public CorneliusEnderFrogGoal(CorneliusEntity cornelius, int minCd, int maxCd) {
    ...
    @Override
    protected Item coin() {
        return CompanionsBlocks.END_COIN.get().asItem();
    }
